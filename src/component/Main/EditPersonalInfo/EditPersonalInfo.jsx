      ...
      <div className="w-[70%] mx-auto h-full grid grid-cols-1">
        ...
        <div className="w-full h-full mt-10  flex justify-start items-center">
          ...
          <div className="ml-5 flex items-center justify-between">
            <div className="text-white -ml-8 mr-5 z-10 bg-[#00aff5] rounded-full p-1">
                <RiEdit2Line size={20}/>
            </div>
            <div>
              <h1 className="mt-2 font-semibold text-3xl">{t("James Don")}</h1>
        ...
        >
          ...
          <Form.Item label={t("Full Name")} name="fullName">
            <CustomInput placeholder={t("Enter your full name")} />
          </Form.Item>
          ...
          <Form.Item label={t("Phone Number")} name="phone">
            <CustomInput type="number" placeholder={t("Enter your phone number")} />
          </Form.Item>
