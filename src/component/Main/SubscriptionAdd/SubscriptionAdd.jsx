  ...
  return (
    <div className="w-full">
      ...
      <div className="flex gap-4 items-center my-6">
        <Link className="flex  items-center my-6" to={`/SubscriptionCard`}><IoChevronBack className="size-6" /><span className="text-2xl font-semibold">{t("Add Subscription")}</span></Link>
      </div>
        ...
        <Form form={form} layout="vertical" onFinish={onFinish} className="mt-5">
          <div className="w-full mb-4">
            ...
            <Form.Item
              ...
              className="w-full"
            >
              <CustomInput placeholder={t("Type name")} className='bg-[#EAF5F7] border-[#00AFF5]' />
            </Form.Item>
          </div>
          ...
          <div className="w-full mb-4">
            ...
            <Form.Item
              ...
              className="w-full"
            >
              <CustomInput placeholder={t("Type price")} className='bg-[#EAF5F7] border-[#00AFF5]' />
            </Form.Item>
          </div>
              ...
              <>
                {fields.map(({ key, name, fieldKey, ...restField }) => (
                  <div className="flex items-center gap-4 mb-3" key={key}>
                    <Form.Item
                      ...
                      className="w-full"
                    >
                      <CustomInput placeholder={t("Type subscription")} className='bg-[#EAF5F7] border-[#2C909D]' />
                    </Form.Item>
                ...
                <Form.Item>
                  <Button
                    ...
                    style={{ width: '100%' }}
                    className="bg-[#EAF5F7] py-5 border border-[#00AFF5]"
                  >
                    {t("Add Fields")}
                  </Button>
                </Form.Item>
